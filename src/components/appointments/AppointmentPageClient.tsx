...
/**
 * Client Component for the Appointment Page
 * 
 * This component is separated from the main page to allow the use of hooks 
 * like `useSettings` and to be safely wrapped in a Suspense boundary in the 
 * Server Page. This fixes the "useSearchParams() should be wrapped in a suspense boundary" 
 * build error in Next.js App Router.
 */
export default function AppointmentPageClient({ searchParams }: AppointmentPageClientProps) {
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900">
            ...
            <section className="py-20 lg:py-24">
                <div className="container max-w-6xl mx-auto px-6">
                    <div className="grid lg:col-span-12 gap-12 items-start lg:grid-cols-12">
