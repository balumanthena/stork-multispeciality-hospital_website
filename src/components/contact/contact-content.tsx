...
export default function ContactContent() {
    ...
    const hospitalName = settings?.hospital_name || "Stork Multispeciality Hospital"
    
    // Hardcoded Google Maps Embed URL to avoid type issues and ensure accuracy
    const googleMapsEmbed = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.1051566418386!2d78.48972107498064!3d17.49755700084473!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9a759082a5c3%3A0x63776e031a0e7135!2sStork%20Multispeciality%20Hospital!5e0!3m2!1sen!2sin!4v1713547200000!5m2!1sen!2sin"
            ...
            <section className="container max-w-7xl mx-auto px-6 -mt-8 relative z-10">
                <div className="bg-red-50 border border-red-100/50 rounded-2xl p-6 md:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex flex-col items-center sm:items-end">
                        <span className="text-[10px] font-black text-red-400 uppercase tracking-widest mb-1">Emergency Helpline</span>
                        <a href={`tel:${emergencyNumber}`} className="text-2xl md:text-3xl font-black text-red-600 tabular-nums">
                            {emergencyNumber}
                        </a>
                    </div>
                </div>
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="flex items-start gap-5 group">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-slate-600 text-[15px] space-y-1">
                                                {workingHours.split("|").map((line, idx) => (
                                    ...
                                    <div className="flex items-start gap-5 group">
                                        ...
                                        <div>
                                            ...
                                            <a href={`tel:${phone}`} className="text-slate-600 text-[15px] hover:text-green-600 transition-colors block mb-1">
                                                {phone}
                                            </a>
