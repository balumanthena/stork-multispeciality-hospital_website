...
export const OrthopaedicsContent = ({ blogs, videos }: { blogs: any[], videos: any[] }) => {
    return (
            ...
            <Section className="py-24 bg-white">
                <div className="container max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-8 leading-tight">
                        ...
                        <span className="text-[#ff8202]">Expert Ortho Care That Gets You Back to Life</span>
                    </h2>
                ...
                <div className="container max-w-7xl mx-auto px-6">
                    <div className="max-w-3xl mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-6">
                            Why People Trust Stork for <span className="text-[#ff8202]">Bone & Joint Care</span>
                        </h2>
                ...
                <div className="container max-w-7xl mx-auto px-6">
                    ...
                    <div className="text-center mt-16 pt-12 border-t border-white/10">
                        <p className="text-2xl font-medium text-white">
                            We’re known for helping patients get back to walking within <span className="text-[#ff8202]">24–48 hours</span> after major joint surgeries and doing it with confidence.
                        </p>
                    </div>
                </div>
            </Section>
            ...
            <Section className="py-24 bg-white">
                <div className="container max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-8 leading-tight">
                        ...
                        <span className="text-[#ff8202]">Total Healing Approach</span>
                    </h2>
