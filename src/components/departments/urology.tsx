...
export const UrologyContent = ({ blogs, videos }: { blogs: any[], videos: any[] }) => {
    return (
            ...
            <Section className="py-24 bg-white">
                <div className="container max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-8 leading-tight">
                        ...
                        <span className="text-[#ff8202]">More Than Silence. Get Answers Today</span>
                    </h2>
                ...
                <div className="container max-w-7xl mx-auto px-6">
                    <div className="max-w-3xl mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-6">
                            Why Patients Choose <span className="text-[#ff8202]">Stork for Urology</span>
                        </h2>
                ...
                <div className="container max-w-7xl mx-auto px-6">
                    ...
                    <div className="text-center mt-16 pt-12 border-t border-white/10">
                        <p className="text-2xl font-medium text-white">
                            Many of these are done as same-day procedures. You walk in, <span className="text-[#ff8202]">walk out with relief</span> and clarity.
                        </p>
                    </div>
                </div>
            </Section>
            ...
            <Section className="py-24 bg-white">
                <div className="container max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-8 leading-tight">
                        ...
                        <span className="text-[#ff8202]">Privacy and Peace of Mind</span>
                    </h2>
