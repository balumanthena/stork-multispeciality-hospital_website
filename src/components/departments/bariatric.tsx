...
export const BariatricContent = ({ blogs, videos }: { blogs: any[], videos: any[] }) => {
    return (
            ...
            <Section className="py-24 bg-white">
                <div className="container max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-8 leading-tight">
                        ...
                        <span className="text-[#ff8202]">And the Scale Won’t Budge</span>
                    </h2>
                ...
                <div className="container max-w-7xl mx-auto px-6">
                    ...
                    <div className="text-center border-t border-slate-200 pt-12">
                        <p className="text-2xl font-serif italic text-slate-800">
                            ...
                            <span className="font-bold not-italic text-[#ff8202] block mt-2">they regain control of their bodies, habits, and confidence.</span>
                        </p>
                    </div>
                </div>
            </Section>
                ...
                <div className="container max-w-7xl mx-auto px-6">
                    ...
                    <div className="text-center mt-16 pt-12 border-t border-white/10">
                        <p className="text-2xl font-medium text-white">
                            ...
                            <span className="text-[#ff8202]">and faster return to normal life.</span>
                        </p>
                    </div>
                </div>
            </Section>
            ...
            <Section className="py-24 bg-white border-b border-slate-100">
                <div className="container max-w-4xl mx-auto px-6 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-8">
                        Weight Loss <span className="text-[#ff8202]">Without Judgment</span>
                    </h2>
