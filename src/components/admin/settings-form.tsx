                    ...
                    <form action={handleSubmit} className="space-y-6">
                        ...
                        <Card className="border border-slate-200 bg-slate-50/50">
                            <CardHeader className="pb-4">
                                ...
                                <CardDescription>Manage your hospital's public social media presence natively affecting the lower footer.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="facebook_url">Facebook URL</Label>
                                        <Input id="facebook_url" name="facebook_url" type="url" defaultValue={initialData.facebook_url || ""} placeholder="https://facebook.com/..." />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="instagram_url">Instagram URL</Label>
                                        <Input id="instagram_url" name="instagram_url" type="url" defaultValue={initialData.instagram_url || ""} placeholder="https://instagram.com/..." />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="twitter_url">Twitter (X) URL</Label>
                                        <Input id="twitter_url" name="twitter_url" type="url" defaultValue={initialData.twitter_url || ""} placeholder="https://twitter.com/..." />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="linkedin_url">LinkedIn URL</Label>
                                        <Input id="linkedin_url" name="linkedin_url" type="url" defaultValue={initialData.linkedin_url || ""} placeholder="https://linkedin.com/..." />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="youtube_url">YouTube URL</Label>
                                        <Input id="youtube_url" name="youtube_url" type="url" defaultValue={initialData.youtube_url || ""} placeholder="https://youtube.com/..." />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="whatsapp_url">WhatsApp URL</Label>
                                        <Input id="whatsapp_url" name="whatsapp_url" type="url" defaultValue={initialData.whatsapp_url || ""} placeholder="https://wa.me/..." />
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
