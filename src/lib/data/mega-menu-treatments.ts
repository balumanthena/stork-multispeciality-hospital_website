export const MEGA_MENU_TREATMENTS = [
    {
        title: "Pain Management",
        items: [
            { title: "Ablation", href: "/treatments/ablation" },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Foot & Ankle Pain", href: "/treatments/foot-ankle-pain" },
            { title: "Hip Pain", href: "/treatments/hip-pain" },
            { title: "Hip Replacement", href: "/treatments/hip-replacement" },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Infectious Disease Management", href: "/treatments/infectious-disease" },
            { title: "Mental Health", href: "/treatments/mental-health" },
            { title: "Metabolic & Endocrine Disorders", href: "/treatments/metabolic-endocrine" },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Diagnostic Procedures", href: "/treatments/diagnostic-procedures" },
    ...
    },
    {
        title: "Spine Care",
        items: [
            { title: "Endoscopic Interlaminar Discectomy", href: "/treatments/endoscopic-interlaminar" },
            { title: "Transforaminal Endoscopic Lumbar Discectomy", href: "/treatments/transforaminal-endoscopic" }
        ]
    },
    {
        title: "Vascular Surgery",
        items: [
            { title: "Deep Vein Thrombosis (DVT)", href: "/treatments/dvt" },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Enlarged Prostate (BPH)", href: "/treatments/enlarged-prostate" },
            { title: "ESWL (Kidney Stone)", href: "/treatments/eswl" },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Piles (Hemorrhoids)", href: "/treatments/piles" },
    ...
    },
    {
        ...
        items: [
            { title: "Frenuloplasty", href: "/treatments/frenuloplasty" },
            { title: "Hoodectomy", href: "/treatments/hoodectomy" },
            { title: "Hymenoplasty", href: "/treatments/hymenoplasty" },
            { title: "Labiaplasty", href: "/treatments/labiaplasty" },
            { title: "Monoplasty", href: "/treatments/monoplasty" },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "FESS Surgery", href: "/treatments/fess" },
            ...
            { title: "Sinus Surgery", href: "/treatments/sinus-surgery" },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Gastrointestinal Issues", href: "/treatments/gastrointestinal" },
    ...
    },
    {
        title: "Pulmonology",
        items: [
            { title: "Asthma", href: "/treatments/asthma" },
            { title: "Bronchoscopy", href: "/treatments/bronchoscopy" },
            { title: "Foreign Body Removal", href: "/treatments/foreign-body-removal" },
            { title: "COPD", href: "/treatments/copd" },
            { title: "Lung Biopsy", href: "/treatments/lung-biopsy" },
            { title: "Lung Cancer Care", href: "/treatments/lung-cancer" },
            { title: "Post-COVID Recovery", href: "/treatments/post-covid" },
            { title: "Respiratory Conditions", href: "/treatments/respiratory-conditions" },
            { title: "TB Management", href: "/treatments/tb-management" }
        ]
    }
]
